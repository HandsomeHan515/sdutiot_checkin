...
{echo "<h4 style='margin-left:18%;'>".$_GET["name"]."的记录：</h4>";
...
while($row = mysql_fetch_array($result))
  {
  echo "<tr><td>".$row['id']."</td><td>".$row['start']."</td><td>".$row['end']."</td><td>".(($row['stay_time']/60)%1000)."小时".($row['stay_time']%60)."分钟</td><td>".$row['duration']."</td><td>".$row['date']."</td><td>".$row['ip']."</td></tr>";
  }
echo "</tbody></table>";
echo "</div>";
echo "<div class='col-md-2'></div>";
